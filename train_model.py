...
def train_model(args):
    ...
    while glob_it < args.num_iters:
        ...
        # if we are using a regularized model, drop the learning rate after 30000 iters and decay from there
        if reg and glob_it > 30000:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--warmup_beta_steps",
                        type=int,
                        default="0",
                        help="Number of warmup steps for the coefficient on the KL divergence loss"
                        )
